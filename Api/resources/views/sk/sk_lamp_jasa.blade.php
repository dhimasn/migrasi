<style type="text/css">
  ...
  .table_layanan, .td_layanan, .th_layanan {
...
<table>
  ...
  <tr>
    ...
    <td style="width: 65%">LAMPIRAN<br/>
      KEPUTUSAN MENTERI KOMUNIKASI DAN INFORMATIKA<br/> 
      REPUBLIK INDONESIA<br/>
      NOMOR {{$no_sk}}<br/>
      TENTANG<br/>
      IZIN PENYELENGGARAAN JASA TELEKOMUNIKASI<br/>
      {{$nama_pt}}
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td style="width: 100%" class="text-center">KATEGORI DAN JENIS LAYANAN JASA TELEKOMUNIKASI</td>
  </tr>
  <tr>
    <td style="width: 100%" class="text-center">{{$nama_pt}}</td>
  </tr>
  <tr>
    <td style="font-size:20px"></td>
  </tr>
...
<table>
  ...
  <tr style="font-size:7px">
    <td width="3%">1.</td>
    <td width="92%" style="text-align:left; font-size:8px;">Dokumen Izin Penyelenggaraan ini merupakan dokumen asli yang berbentuk elektronik dan menggunakan tanda tangan elektronik yang sah dan memiliki kekuatan hukum.</td>
  </tr>
  <tr style="font-size:7px">
    <td width="3%">2.</td>
