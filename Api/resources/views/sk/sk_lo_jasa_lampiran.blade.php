...
<table>
  <tr>
    <td style="font-weight: bold; width: 100%; text-align: center;">BERITA ACARA EVALUASI UJI LAIK OPERASI<br>
                          JASA TELEKOMUNIKASI LAYANAN {{$jenis_layanan_k}}
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="width: 90%; text-align: justify;">Pada hari ini {{$tgl_ulo}}, telah selesai dilakukan Evaluasi Uji Laik Operasi dengan metode {{$metode_uji}} pada Jasa Telekomunikasi Layanan {{$jenis_layanan}} milik {{$nama_pt}} dengan hasil sebagai berikut :<br></td>
  </tr>
  <tr>
