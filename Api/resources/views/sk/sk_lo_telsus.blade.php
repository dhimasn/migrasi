...
<table>
  ...
  <tr>
    ...
    <td style="width: 80%; text-align: justify;">Surat Tugas Direktur Telekomunikasi Nomor: {{$no_surat_tugas_dir}} tanggal {{$tgl_surat_tugas_dir}} untuk melaksanakan Uji Laik Operasi (ULO) {{$jenis_layanan}}
    <br></td>
  </tr>
  <tr>
    <td style="width: 15%"></td>
