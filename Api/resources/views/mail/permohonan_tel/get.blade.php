...
@section('title', 'Daftar Permohonan Telekomunikasi')
@section('content')

<div class="banner">
    <h3>Daftar Permohonan Izin Telekomunikasi</h3>
</div>
<div class="container">
            ...
            <div class="card card-custom">
                <div class="card-header h-auto py-4">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">
                            Daftar Permohonan Izin Telekomunikasi
                        </h3>
                    </div>
...
<!--end::Entry-->
<script src="/assets/js/app/tel/get_permohonan.js"></script>
@endsection