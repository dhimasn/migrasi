...
@section('title', 'Perbaikan Komitmen Permohonan Telekomunikasi')
@section('content')

<div class="banner">
    <h3>Perbaikan Komitmen Permohonan Telekomunikasi</h3>
</div>
<!--begin::Entry-->
<div class="container">
            ...
            <div class="card card-custom">
                <div class="card-header h-auto py-4">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">
                            Perbaikan Komitmen Permohonan Telekomunikasi
                        </h3>
                    </div>
                </div>
            </div>
    ...
    <script src="/assets/js/app/tel/edit_komitmen.js"></script>
