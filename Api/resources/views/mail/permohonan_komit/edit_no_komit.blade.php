...
@section('title', 'Perbaikan Permohonan Telekomunikasi')
@section('content')

<div class="banner">
    <h3>Perbaikan Permohonan Telekomunikasi</h3>
</div>
<!--begin::Entry-->
<div class="container">
            ...
            <div class="card card-custom">
                <div class="card-header h-auto py-4">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">
                            Perbaikan Permohonan Telekomunikasi
                        </h3>
                    </div>
                </div>
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <input type="hidden" id="id_permohonan_no_komit_file">
                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                            <button type="button" class="btn btn-success" onclick="ViewKelengkapanPenomoran()">Lihat</button>
                            <button type="button" class="btn btn-primary" onclick="DownloadKelengkapanPenomoran()">Unduh</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="/assets/js/app/tel/download_kelengkapan.js"></script>
    <script src="/assets/js/app/tel/get_view_file_kelengkapan.js"></script>
    <script src="/assets/js/app/tel/edit_no_komit.js"></script>
