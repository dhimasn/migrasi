  ...
  <div class="container">
      <div class="row">
        <div class="col-xl-12">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="{{route('perpres_kepres')}}">Perpres & Kepres</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{route('permen_kepmen')}}">Permen & Kepmen</a>
            </li>    
            </ul>
        </div>
    </div>
...
<script src="/assets/js/app/publikasi/get_regulasi_by_perpres_kepres.js"></script>
@endsection