...
<table>
  ...
  <tr>
    <td style="width: 100%; text-align: center">PENETAPAN KOMITMEN LAYANAN<br>{{$jenis_layanan_k}}<br/>{{$nama_pt}}
    </td>
  </tr>
  <tr>
    <td style="font-size:10px">&nbsp;</td>
  ...
  <tr>
      ...
      <td width="3%">:</td>
      <td width="72%" style="text-align:justify">{{$nama_pt}}<br>Sebagai Penyelenggara jasa telekomunikasi berdasarkan Keputusan Menteri Komunikasi dan Informatika No. {{$no_sk}} tentang Izin Penyelenggaraaan Jasa Telekomunikasi {{$nama_pt}}<br></td>
  </tr>
  <tr>
      <!-- <td width="5%">&nbsp;</td> -->
      <td width="5%">1.</td>
      <td width="95%" style="text-align:justify">telah memenuhi pernyataan komitmen persyaratan perizinan dan penyelenggaraan jasa telekomunikasi berdasarkan permohonan nomor {{$no_permohonan}}.</td>
  </tr>
  <tr>
      <!-- <td width="5%">&nbsp;</td> -->
      <td width="5%">2.</td>
      <td width="95%" style="text-align:justify">wajib menyediakan komitmen penyediaan layanan jasa telekomunikasi sebagai berikut:<br>{{$jenis_layanan}}</td>
  </tr>
...
<table>
 ...
 <!--  <tr>
    <td width="95%" style="text-align:left; font-size:9px">4. Direktur Telekomunikasi (sebagai laporan).</td>
  </tr> -->
  <!-- <tr>
    <td style="font-size:4px"></td>
  </tr> -->
