...
class MigrasiBerkasJaringanController extends Controller
{
    private $pdbOld;
    private $pdbNew;
    private $syarat;
    ...
    public function MigrasiBerkasJaringan(Request $re)
    {   
        DB::beginTransaction();
        try {
            ...
            #p_permohonan
            $data_permohonan = $this->pdbNew->GetPermohonanNewByIdjenisIzin(2);
                ...
                foreach($data_permohonan as $data_perm_new){
                    ...
                    if(!empty($p_permohonan_komit)){
                        ...
                        //                             foreach($syarat_komit as $komitmen){
                                            ...
                                            //                         $this->pdbNew->CreatePermohonanKinerja($p_permohonan_komit_layanan->id, $syarat_izin_p, $m_syarat_izin_p->teks_judul);
                                            //                     }
                                            //                 }      
                                            //             }                                            
                                            //         }
                                            //         #p_permohonan_kinerja_status
                                            //         $this->pdbNew->CreatePermohonanKinerjaStatus($p_permohonan_komit_layanan->id, 4);
                                            //     }
                                            // }
                                        //}
                                    //}
